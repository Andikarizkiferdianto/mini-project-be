...
class KelasResource:
    ...
    def on_post(self, req, resp):
        ...
        try:
            ...
            tahun_obj = TahunAjaran.get(
                id=payload.get('id_tahun_ajaran')
            )
            ...
            resp.text = json.dumps({
                "message": f"Gagal tambah kelas: {str(e)}"
            })
...
class KelasWithIdResource:
    ...
    def on_put(self, req, resp, kelas_id):
        ...
        kelas.kode_kelas = payload.get(
            'kode_kelas',
            kelas.kode_kelas
        )

        kelas.nama_kelas = payload.get(
            'nama_kelas',
            kelas.nama_kelas
        )

        kelas.wali_kelas_name = payload.get(
            'wali_kelas_name',
    ...
    def on_delete(self, req, resp, kelas_id):
        ...
        resp.text = json.dumps({
            "message": f"Kelas {nama_kelas} berhasil dihapus!"
        })